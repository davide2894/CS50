...
function addMarker(place)
{
    ...
    //define marker label
    var label = place.placeName + ", " + place.adminName1;

    //create new marker with defined position, icon and label
    ...
    //push marker in array of markers
    markers.push(marker);

    var parameters = {geo: place.postalCode};

    //on click: open info windown showing location's recent articles
...
//set map on all markers inside the array
    ...
    },
    {
        ...
        templates: {
            suggestion: Handlebars.compile(
                "<div>" +
                "{{ placeName }}, {{ adminName1 }}, {{ postalCode }}" +
                "</div>"
            )
        }
    });
